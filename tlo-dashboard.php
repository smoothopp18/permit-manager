                        ...
                        <?php foreach ($applications as $application) : ?>
                          ...
                          <tr>
                            ...
                            <?php if($application['status'] == 'Pending'){ ?>
                                <td><div class="badge badge-primary badge-shadow"><?php echo $application['status']; ?></div></td>
                            <?php }else if($application['status'] == 'Approved'){ ?>
                                <td><div class="badge badge-success badge-shadow"><?php echo $application['status']; ?></div></td>
                            <?php }else if($application['status'] == 'Rejected'){ ?>
                                <td><div class="badge badge-danger badge-shadow"><?php echo $application['status']; ?></div></td>
                             <?php   } ?>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="actionMenu">
                                  ...
                                  <a class="dropdown-item view-documents" href="application-documents.php?application_id=<?= $application['application_id']; ?>">View Documents</a>
